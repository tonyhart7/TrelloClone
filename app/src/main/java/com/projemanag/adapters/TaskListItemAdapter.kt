    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            ...
            holder.itemView.ib_done_list_name.setOnClickListener {
                ...
                if (listName.isNotEmpty()){
                    ...
                    Toast.makeText(context, "You cant Create Empty Board", Toast.LENGTH_SHORT).show()
                }
            }
        }
        ...
        holder.itemView.ib_done_edit_list_name.setOnClickListener {
            ...
            if (listName.isNotEmpty()){
                ...
                Toast.makeText(context, "Please Enter a ListName", Toast.LENGTH_SHORT).show()
            }
        }
        ...
        holder.itemView.ib_done_card_name.setOnClickListener {
            ...
            if (cardName.isNotEmpty()){
                ...
                Toast.makeText(context, "Please Enter a CardName", Toast.LENGTH_SHORT).show()
            }
        }
